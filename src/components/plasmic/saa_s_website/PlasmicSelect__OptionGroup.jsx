...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: vU3MJ2dRAu1CRQ/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Ptb8BDgatfNdxx/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__v9VIq)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__seb0Z)}
              />
            </React.Fragment>
          ),
