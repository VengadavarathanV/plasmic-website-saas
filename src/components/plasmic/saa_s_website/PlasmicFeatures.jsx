...
import sty from "./PlasmicFeatures.module.css"; // plasmic-import: T1ouYVRBXr8rpW/css
import Icon16Icon from "./icons/PlasmicIcon__Icon16"; // plasmic-import: 10lq186Idv9yY9/icon
import ArrowRightsvgIcon from "./icons/PlasmicIcon__ArrowRightsvg"; // plasmic-import: gm_BEJaLC5ip7u/icon
import williamHook9E9Pd9BlAtoUnsplashjpgSpLMtMuUlaFImU from "./images/williamHook9E9Pd9BlAtoUnsplashjpg.jpeg"; // plasmic-import: SpLMtMUUlaFImU/picture
import _3ThumbjpgEz9AOaif667Wvb from "./images/_3Thumbjpg.jpeg"; // plasmic-import: EZ9aOaif667wvb/picture
    ...
    <React.Fragment>
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__jm0FH)}>
              <p.Stack
                as={"div"}
              ...
              >
                <div className={classNames(projectcss.all, sty.column__s9Olq)}>
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___15Wkr)}
                  >
                    <h1
                ...
                <div className={classNames(projectcss.all, sty.column__dOg2I)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__sdPuN)}
                    displayHeight={"auto"}
                    ...
                    src={
                      hasVariant(globalVariants, "screen", "mobileOnly")
                        ? {
                            src: _3ThumbjpgEz9AOaif667Wvb,
                            fullWidth: 700,
                            fullHeight: 466,
                            aspectRatio: undefined
                          }
                        : {
                            src: williamHook9E9Pd9BlAtoUnsplashjpgSpLMtMuUlaFImU,
                            fullWidth: 1920,
                            fullHeight: 1280,
                            aspectRatio: undefined
                          }
          ...
          <div className={classNames(projectcss.all, sty.freeBox__bq4Jn)}>
            <p.Stack
              as={"section"}
            ...
            >
              ...
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox___6CEYm)}
                >
                  <h3
                    className={classNames(
                      projectcss.all,
                ...
                <div className={classNames(projectcss.all, sty.freeBox__kpMdU)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__f3Cy8)}
                  >
                    <h5
                      className={classNames(
                        projectcss.all,
                    ...
                    <Icon16Icon
                      className={classNames(projectcss.all, sty.svg___9Kqro)}
                      role={"img"}
                    />
                  </div>

                  <div
                    className={classNames(projectcss.all, sty.freeBox__boNlF)}
                  >
                    <h5
                      className={classNames(
                        projectcss.all,
                    ...
                    <Icon16Icon
                      className={classNames(projectcss.all, sty.svg__d8G8V)}
                      role={"img"}
                    />
                  </div>

                  <div
                    className={classNames(projectcss.all, sty.freeBox__mrtxw)}
                  >
                    <h5
                      className={classNames(
                        projectcss.all,
                    ...
                    <Icon16Icon
                      className={classNames(projectcss.all, sty.svg__qAzlx)}
                      role={"img"}
                    />
                  </div>

                  <div
                    className={classNames(projectcss.all, sty.freeBox__r7K4C)}
                  >
                    <h5
                      className={classNames(
                        projectcss.all,
                    ...
                    <Icon16Icon
                      className={classNames(projectcss.all, sty.svg___7XvFj)}
                      role={"img"}
                    />
                  </div>

                  <div
                    className={classNames(projectcss.all, sty.freeBox___50Wi9)}
                  >
                    <h5
                      className={classNames(
                        projectcss.all,
                    ...
                    <Icon16Icon
                      className={classNames(projectcss.all, sty.svg__uS9X)}
                      role={"img"}
                    />
                  </div>
                </div>
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lz813)}>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__z5TQt)}
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox___4LYi9)}
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__u3C4E)}
                  >
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__m3MgK)}
                    >
                      <p.Stack
                        as={"div"}
                  ...
                  >
                    <p.PlasmicImg
                      alt={""}
                      className={classNames(sty.img__gsxUf)}
                      displayHeight={"100%"}
                      displayMaxHeight={"none"}
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__hqAeO)}
                    />
                  </div>
                </div>
              </p.Stack>
