...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: M4Ie8C1t_mn5s/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: KSZY7lyKVAi7V1/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: T863VT7STe2zHz/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__aQeMg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___1Vma4)}
                role={"img"}
              />
            ),
