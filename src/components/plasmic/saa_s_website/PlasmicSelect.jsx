...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: o0P7-8zaberHwQ/component
import Select__Option from "../../Select__Option"; // plasmic-import: B1MWiT38oZ9Xym/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_saa_s_website.module.css"; // plasmic-import: 9DRVreLqCyHSecyifmovL7/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Ptb8BDgatfNdxx/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: t0QUOqdGxbxrKw/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: bWdcrh0Z04GXoR/icon
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__mhDb)}
                      value={"value2"}
                    >
                      {"Option 2"}
                    </Select__Option>
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__kh6Wb)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
